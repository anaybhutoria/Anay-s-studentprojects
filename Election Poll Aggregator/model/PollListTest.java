package model;
/**
 * Updated JUnit test to work with exceptions
...
public class PollListTest {
	class PollMock extends Poll {
		...
		PartyMock[] parties;
		int nextIndex = 0;
		public PollMock(String name, int maxNumberOfParties) throws InvalidSetupDataException {
	...
	class PartyMock extends Party {
		...
		public PartyMock(String partyName, float seats, float votes) throws InvalidPartyDataException {
			super(partyName);
	...
	@Test
	public void test_Constructor_negativePollsAndSeats() throws InvalidSetupDataException {
		try {
		PollList pl = new PollList(-1,-2);
		fail("InvalidSetupDataException not thrown");
		}catch(InvalidSetupDataException e) {
		}
	}

	@Test
	public void test_Constructor_onePollsAndtwoSeats() throws InvalidSetupDataException {
		PollList pl = new PollList(1,2);
	...
	@Test
	public void test_Constructor_tenPollsAndoneSeats() throws InvalidSetupDataException {
	...
	@Test
	public void test_addPoll_toEmptyList()throws InvalidSetupDataException {
	...
	@Test
	public void test_addPoll_addingNull() throws InvalidSetupDataException {
		Poll p = new PollMock("test", 5);
		PollList pl = new PollList(5, 20);
	...
	@Test
	public void test_addPoll_fillList()throws InvalidSetupDataException {
	...
	@Test
	public void test_addPoll_pollAlreadyExistsAtIndex0()throws InvalidSetupDataException {
	...
	@Test
	public void test_addPoll_pollAlreadyExistsAtIndex1()throws InvalidSetupDataException {
		Poll p1 = new PollMock("test1", 1);
	...
	@Test
	public void test_addPoll_pollAlreadyExistsAtLastIndex_DifferentCase()throws InvalidSetupDataException {
		Poll p1 = new PollMock("test1", 1);
		Poll p2 = new PollMock("test2", 2);
	...
	@Test
	public void test_addPoll_listIsFull()throws InvalidSetupDataException {
		Poll p1 = new PollMock("test1", 1);
		Poll p2 = new PollMock("test2", 2);
		Poll p3 = new PollMock("test3", 3);
		PollList pl = new PollList(3, 45);
	...
	@Test
	public void test_getAveragePartyData_PartyInAllPolls() throws InvalidPartyDataException, InvalidSetupDataException {
		// setup first poll
	...
	@Test
	public void test_getAveragePartyData_PartyInSomePolls() throws InvalidPartyDataException, InvalidSetupDataException {
		// setup first poll
		PartyMock[] parties1 = new PartyMock[3];
		parties1[0] = new PartyMock("zero", 100f, .25f);
		parties1[1] = new PartyMock("one", 200f, .5f);
	...
	@Test
	public void test_getAveragePartyData_PartyInNoneOfThePolls() throws InvalidSetupDataException {
		// setup first poll
		PartyMock[] parties1 = new PartyMock[3];
		parties1[0] = null;
		parties1[1] = null;
	...
	@Test
	public void test_getAggregatePoll_AllPollsSameSize_noNormalizingNeeded() throws InvalidPartyDataException, InvalidSetupDataException {
		// setup first poll
		PartyMock[] parties1 = new PartyMock[3];
		parties1[0] = new PartyMock("zero", 100f, .25f);
		parties1[1] = new PartyMock("one", 200f, .5f);
	...
	@Test
	public void test_getAggregatePoll_somePollsMissingParties_noNormalizingNeeded() throws InvalidPartyDataException, InvalidSetupDataException {
		// setup first poll
		PartyMock[] parties1 = new PartyMock[3];
		parties1[0] = new PartyMock("zero", 100f, .25f);
		parties1[1] = null;
	...
	@Test
	public void test_getAggregatePoll_normalizingNeededForVotes() throws InvalidPartyDataException, InvalidSetupDataException {
		// setup first poll
	...
	@Test
	public void test_getAggregatePoll_normalizingNeededForSeats() throws InvalidPartyDataException, InvalidSetupDataException {
		// setup first poll
		PartyMock[] parties1 = new PartyMock[4];
		parties1[0] = new PartyMock("zero", 100f, .25f);
		parties1[1] = new PartyMock("one", 150f, .45f);
	...
	@Test
	public void test_toString1() throws InvalidSetupDataException {
	...
	@Test
	public void test_toString2() throws InvalidSetupDataException {
